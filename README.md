...
Day 1: we wanted create both repositores and installed everything we needed like create react app etc... Then we created our api.
Day 2: we started adding basic funtionality to the backend.
Day 3: We completed all the functionality on our backend.
Day 4: next we wanted to start creating basic functionality to our fron end to display our data (CRUD).
Day 5: we wrapped up our front end with all our components.
Day 6: we made sure our app was functinal and depoloyed anf front and back.
Day 7: we wrapped up all the little inperfections and prepared for our presentation.
### Wireframe
